...
function setup() {
	...
	packageSprite.scale=0.2
	 packageSprite.setCollider("rectangle",500,10,50,50,30);
...
function draw() {
	...
	helicopterSprite.collide(groundSprite);
...
if(helicopterSprite.isTouching(packageSprite)){
	textSize(20);
	text("Package will be deployed now", 10,600);
...
function keyPressed(){
	...
	if(keyDown("DOWN_ARROW")){
		...
		textSize(20);
		text("Package has been delivered", 500,400);
	}
}
